...
import './api'
// 按需引用element
import {Button, Input, Loading, Message, MessageBox, Notification, Popover, Tag} from 'element-ui'
...
const router = new VueRouter({
  routes: [
    ...
    {path: '/admin/', components: {default: article, sidebar: sidebar}},
    {path: '/admin/article', components: {default: article, sidebar: sidebar}},
    ...
    {path: '/admin/articleEdit/:articleId', component: articleEdit},
