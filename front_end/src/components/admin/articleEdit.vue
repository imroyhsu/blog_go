  ...
  export default {
    ...
    mounted: function () {
      if (this.$route.params.articleId) {
        this.$axios.get(global.articleDetail, {
          params: {
    ...
    methods: {
      ...
      saveArticle: function () {
        ...
        if (this.$route.params.articleId) {
          ...
          this.$axios.put(global.updateArticle, {
            'articleId': this.$route.params.articleId,
            'title': this.title,
            'date': this.date,
            'content': this.content,
            ...
            response => {
              ...
              // 更新完成后跳转至该文章的详情页
              self.$router.push('/articleDetail/' + self.$route.params.articleId)
            },
            response => console.log(response)
          )
        } else {
          ...
          this.$axios.post(global.saveArticle, {
